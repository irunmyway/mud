...
public class UsePanel extends BaseCommand {
    ...
    public void execute() {
        ...
        choice.add(Choice.createChoice("使用", Enum.messageType.action,"item_use",itemId+"",null, Enum.winAction.close));
        choice.add(Choice.createChoice("查看", Enum.messageType.action,"item_look",itemId+"",null));
        choice.add(Choice.createChoice("丢弃", Enum.messageType.action,"item_drop",itemId+"",null, Enum.winAction.close));
