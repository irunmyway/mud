...
public class GameChatWindow extends BaseWindow implements IButtonCallBack {
    ...
    public GameChatWindow build(Activity context, View target, String key, String name){
        this.key = key;
        this.content = name;
    ...
    public GameChatWindow setList(List<Choice> choices, WinMessage winMessage){
